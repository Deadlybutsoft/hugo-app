...
import { BurnIntro } from "@/components/burn-intro"
import { MovingTextBoard } from "@/components/moving-text-board"
...
export default function Home() {
  ...
  return (
    <>
      {/* Burn Intro Animation */}
      {showBurnIntro && !introComplete && (
        <BurnIntro onComplete={handleIntroComplete} />
      )}
      ...
      <div className="min-h-screen w-full relative bg-black">
        ...
        >
          ...
          >
            <span className="text-2xl font-bold text-foreground" style={{ fontFamily: "var(--font-poppins)" }}>Hugo</span>
          </a>
          ...
          <div className="flex items-center gap-4">
            <a
              href="/chat"
              className="rounded-md font-bold relative cursor-pointer hover:-translate-y-0.5 transition duration-200 inline-flex items-center gap-2 text-center bg-gradient-to-b from-primary to-primary/80 text-primary-foreground shadow-[0px_2px_0px_0px_rgba(255,255,255,0.3)_inset] px-4 py-2 text-sm"
            >
        ...
        <header className="fixed top-4 left-4 right-4 z-[9999] flex w-auto flex-row items-center justify-between rounded-full bg-black/50 backdrop-blur-md border border-white/10 shadow-lg md:hidden px-4 py-3">
          <a
            ...
            rel="noopener noreferrer"
          >
            <span className="text-xl font-bold text-foreground" style={{ fontFamily: "var(--font-poppins)" }}>Hugo</span>
          </a>
            ...
            <div className="absolute top-20 left-4 right-4 bg-background/95 backdrop-blur-md border border-border/50 rounded-2xl shadow-2xl p-6">
              <nav className="flex flex-col space-y-4">
                ...
                <div className="border-t border-border/50 pt-4 mt-4 flex flex-col space-y-3">
                  <a
                    href="/chat"
                    className="px-4 py-3 text-lg font-bold text-center bg-gradient-to-b from-primary to-primary/80 text-primary-foreground rounded-lg shadow-lg hover:-translate-y-0.5 transition-all duration-200 inline-flex items-center justify-center gap-2"
                  >
