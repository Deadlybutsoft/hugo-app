  ...
  const faqs = [
    {
      ...
      answer:
        "The core flow is free. Certain advanced registration paths may include fees depending on the protocol.",
    },
    {
      question: "What if the AI detects similarity?",
      answer:
        "You'll get a clear explanation before anything is submitted, so you stay fully informed.",
    },
    {
      question: "What types of files can I upload?",
      answer:
        "Nearly anything: text, images, code snippets, audio, or mixed media.",
    },
    {
      question: "Where is my IP stored?",
      answer:
