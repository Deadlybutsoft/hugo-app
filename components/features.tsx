              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="text-md text-muted-foreground flex flex-col gap-2 text-sm">
                  <p className="max-w-[460px]">
                    Our AI analyzes your work and detects potential similarities before submission, keeping you fully informed and protected from legal issues.
                  </p>
                </div>
              </div>
            ...
            >
              ...
              <div className="flex min-h-[300px] grow items-start justify-center select-none">
                <h1 className="mt-8 text-center text-5xl leading-[100%] font-semibold sm:leading-normal lg:mt-12 lg:text-6xl">
                  <span className='bg-background relative mt-3 inline-block w-fit rounded-md border px-1.5 py-0.5 before:absolute before:top-0 before:left-0 before:z-10 before:h-full before:w-full before:bg-[url("/noise.svg")] before:opacity-[0.09] before:content-[""]'>
                    <ScrambleHover
                      text="feature-2"
                      scrambleSpeed={70}
                      maxIterations={20}
